...
const userSchema = new mongoose.Schema({
  ...
  // La contraseña no es obligatoria porque los usuarios
  // registrados mediante Google no tienen contraseña local.
  passwordHash: {
    type: String,
    required: false
  },

  // Método utilizado para autenticar al usuario
  proveedorAuth: {
    type: String,
    enum: ['local', 'google'],
    default: 'local'
  ...
  // Identificador único proporcionado por Google
  googleId: {
    type: String,
    unique: true,
    sparse: true
